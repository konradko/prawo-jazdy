...
def parse_arguments():
    ...
    parser.add_argument("-i", "--input", help="Input XLSX file name", required=True)
    parser.add_argument("-m", "--media", help="Media directory", required=True)
    parser.add_argument("-o", "--output", help="Output directory", required=True)
    parser.add_argument("-c", "--category", help="License category", required=True)
    parser.add_argument(
        "-s", "--system", help="Operating system", required=False, default="windows", choices=["windows", "linux"]
    )
